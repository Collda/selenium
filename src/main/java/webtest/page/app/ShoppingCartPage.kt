...
class ShoppingCartPage: AbstractTechnicalPage() {
    override fun isOpen(): Boolean = elements().findElement(cartContentContainer).isDisplayed

    private var priceSummary: Double = 0.0

    private val cartContentContainer: ElementDef = ElementDef(ComponentType.FRAME, "", By.ByClassName("cart_contains_container"))
    private val checkoutButton: ElementDef = ElementDef(ComponentType.BUTTON, "", "checkout")
    ...
    fun clickOnCheckout(): CheckoutYourInformationPage {
