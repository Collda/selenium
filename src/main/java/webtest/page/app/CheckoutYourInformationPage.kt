...
class CheckoutYourInformationPage : AbstractTechnicalPage() {
    ...
    private val checkoutInfoContainer: ElementDef = ElementDef(ComponentType.FRAME, "", "checkout_info_container")
    ...
    fun checkoutOverviewInfo(): CheckoutOverviewPage {
        val checkoutYourInformationPage = CheckoutYourInformationPage()
        checkoutYourInformationPage.fillInfo(
            PropertiesData.getFirstName(),
            PropertiesData.getLastname(), PropertiesData.getPostalCode()
        )
